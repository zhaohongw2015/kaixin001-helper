...
namespace SNSHelper_UnitTest
{
    ...
    public class ParkingHelperTest
    {
        ...
        public void PurchaseACarTest()
        {
            ...
            string carID = "3"; // TODO: 初始化为适当的值
            CarColor color = CarColor.Blue; // TODO: 初始化为适当的值
            bool expected = true; // TODO: 初始化为适当的值
            bool actual;
            actual = helper.BuyCar(carID, color);
        ...
        public void BuyCardTest()
        {
            ...
            string cardId = "15"; // TODO: 初始化为适当的值
            bool expected = true; // TODO: 初始化为适当的值
            bool actual;
            actual = helper.BuyCard(cardId);
            Assert.AreEqual<bool>(expected, actual);
        }
        ...
        public void IsCardExsitTest()
        {
            ...
            string cardId = "2"; // TODO: 初始化为适当的值
            bool expected = true; // TODO: 初始化为适当的值
            bool actual;
            actual = helper.IsCardExsit(cardId);
            Assert.AreEqual<bool>(expected, actual);
        }
    }
}

...
namespace SNSHelper_Win
{
    public partial class frmMain
    {
        ...
        private Thread tLoadFriendData;
        ...
        private void BeginToGetFriendData()
        {
            ...
            ShowNetworkingStatus_InitFriend(string.Format("正在登录...", txtNewLoginEmail));

            tLoadFriendData = new Thread(ShowIniFriendDetails);
            tLoadFriendData.Start();
        }
